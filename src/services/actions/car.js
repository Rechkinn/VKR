...
export const CAR_CREATE_REQUEST_RESET = "CAR_CREATE_REQUEST_RESET";
...
export const EDIT_CAR_REQUEST_RESET = "EDIT_CAR_REQUEST_RESET";
...
export const REMOVE_CAR_REQUEST_RESET = "REMOVE_CAR_REQUEST_RESET";
